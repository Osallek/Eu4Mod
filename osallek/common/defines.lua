...
NDiplomacy = {
	...
	INTEGRATE_VASSAL_MIN_YEARS = 8,				-- Number of years before a vassal can be integrated
...
NCountry = {
	...
	EMBRACE_INSTITUTION_COST = 2.0,				-- 2.5 per development (autonomy modified)
	...
	REPUBLICAN_TRADITION_YEARLY_INCREASE = 2,		-- how much it increases each year.
	...
	ADVISOR_COST_INCREASE_PER_YEAR = 0.004,			-- yearly increase in price in percent,
	...
	PROMOTE_COST_MONTHS_ADVISOR_SALARY = 40.0,		-- Promote advisor cost in monthly salaries
	...
	IDEA_TO_TECH = -0.03,			-- percentage on tech reduction per idea.
	...
	ABANDON_IDEAGROUP_REFUND = 1.00,				-- The part of the idea group spent that will be refunded upon abandonment.
	...
	POPULATION_GROWTH = 0.05, 						-- _CDEF_POPULATION_GROWTH_; Base population growth.
	COLONIAL_GROWTH_PENALTY = 100, 					-- growth penalty for low colonial maintenance
	MAX_NATIONALISM = 10,
	YEARS_OF_NATIONALISM = 20, 						-- _CDEF_YEARS_OF_NATIONALISM_; Years of Nationalism
	...
	HIGH_LIBERTY_DESIRE = 100, 						-- Limit for when a subject starts getting rebellious from liberty desire (also used for alert)
	...
	ALLOWED_TERRITORY_VS_MAX_STATES = 10.0, -- Defines how much percentage compared to your max states you are allowed to have as territory without penalty
...
NEconomy = {
	...
	ADVISOR_COST = 0.9,								-- Advisor cost modifier
	GOLD_INFLATION_THRESHOLD = 0.0,					-- _EDEF_GOLD_INFLATION_THRESHOLD_
	GOLD_INFLATION = 0.0,							-- _EDEF_GOLD_INFLATION_
	...
	BANKRUPTCY_BUILDING_DESTRUCTION_THRESHOLD = 1,	-- Bankruptcy will destroy building that have been build in the latest X amount of years. Set to zero to disable the destruction mechanic.
	...
	BASE_INTERESTS = 3.0,							-- Base interests
	LAND_MAINTENANCE_FACTOR = 0.25,					-- _EDEF_LAND_MAINTENANCE_FACTOR
	HEAVY_SHIP_MAINT_FACTOR = 0.01,					-- _EDEF_HEAVY_SHIP_MAINT_FACTOR_
	LIGHT_SHIP_MAINT_FACTOR = 0.01,					-- _EDEF_LIGHT_SHIP_MAINT_FACTOR_
	GALLEY_MAINT_FACTOR = 0.01,						-- _EDEF_GALLEY_MAINT_FACTOR_
	...
	MERCHANT_SPEED = 200.0,							-- MERCHANT_SPEED
	...
	CARAVAN_FACTOR = 1.0,							-- Development is divided by this factor, do not set to zero!
	...
	CONSTRUCT_IN_SUBJECT_TIME_MULTIPLIER = 1.00,
...
NMilitary = {
	...
	MAX_MANPOWER = 13, 								-- years in mp pool
	...
	MAX_REBEL_SUPPRESSION = 50.0;				-- Maximum amount of rebel suppression by troops in a province
	...
	AREA_REBEL_SUPPRESSION_MULTIPLIER = 50.0,		-- Armies suppressing rebels in areas adds this/<number of suppressed provinces> to rebel suppression in affected provinces.
...
NReligion = {
	...
	RELIGIOUS_LEAGUE_COOLDOWN = 1,								-- Minimum years between joining/leaving religious league
	RELIGIOUS_LEAGUE_WAR_BONUS_DURATION = 200,					-- How many years the 'Joined League War' bonus lasts
	MAX_CHRISTIAN_RELIGIOUS_CENTERS = 6,						-- The number of spawned centers of reformation wont exceed this number
	MAX_RELIGIOUS_CENTER_SPREAD_DISTANCE = 50.0,				-- When spreading the religion to other provinces the distance wont exceed this number
	CONVERSION_ZEAL_DURATION = 1950,							-- Amount of days in which you cannot convert the province back.
	KARMA_FOR_CONVERSION = 0.1,
	MIN_CARDINALS = 7,											-- Least amount of cardinals/ Starting cardinals
	MAX_CARDINALS = 98,											-- Max amount of cardinals
	MAX_CARDINALS_PER_COUNTRY = 14,								-- Max cardinals in a single country
...
NNationDesigner = {
	...
	IDEAS_MAX_LEVEL = 40,					-- Can be overriden in script
	...
	GOVERNMENT_RANK_COST_4 = 30,
	GOVERNMENT_RANK_COST_5 = 30,
	GOVERNMENT_RANK_COST_6 = 30,
	GOVERNMENT_RANK_COST_7 = 30,
	GOVERNMENT_RANK_COST_8 = 30,
	GOVERNMENT_RANK_COST_9 = 30,
	GOVERNMENT_RANK_COST_10 = 30,
...
NGovernment = {
	...
	GOVERNMENT_REFORM_YEARLY_BASE_PROGRESS = 15.0,
	GOVERNMENT_REFORM_HISTORIC_AUTONOMY = 0.25,
	GOVERNMENT_REFORM_CHANGE_CORRUPTION = 0.01,
